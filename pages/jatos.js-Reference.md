...
As of version 3 the group session data can be access via the [`jatos.groupSession` functions](#accessing-the-group-session---jatosgroupsession).
...
### Accessing the group session - `jatos.groupSession`
