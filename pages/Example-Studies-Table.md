...
| [2048 Game](https://github.com/JATOS/JATOS_examples/raw/master/examples/2048.zip) | This addictive game is created by [Gabriele Cirulli](https://github.com/gabrielecirulli/2048). | None | None |  <img src="images/example-studies/Screenshot_2048Game.png" style="width:200%"/>|
...
| [Attentional Capture](https://github.com/JATOS/JATOS_examples/raw/master/examples/reward_capture.osexp.zip) | Standard task to show how to use OSWeb with JATOS. | [OpenSesame](https://osdoc.cogsci.nl/), [OSWeb](https://osdoc.cogsci.nl/manual/osweb/#the-osweb-extension) | None |  <img src="images/example-studies/Screenshot_osweb_reward_capture.png" style="width:200%"/>|
