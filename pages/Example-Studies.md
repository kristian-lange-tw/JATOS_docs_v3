...
Another library of examples of psychological experiments is the [Experiment Factory](https://expfactory.github.io/table.html). All those experiments there are easily jatosifyable - like we did with the (Self Regulation Survey)[#self-regulation-survey-from-the-experiment-factory].
